...
# --- IMAGEN GENERADA (TALARA) ---
# Usamos el enlace que proporcionaste
IMG_TALARA_GENERADA = "http://googleusercontent.com/image_generation_content/0"

# Imagen pequeña para el sidebar (Bandera Perú Estilizada)
...
# ==================================================
with st.sidebar:
    # 1. IMAGEN PEQUEÑA SUPERIOR
    c_icon, c_space = st.columns([1, 4])
    with c_icon:
        st.image(IMG_FLAG_ICON, width=40) # Bandera pequeña
    ...
    # 3. REFRÁN / LEMA (Agregado)
    st.markdown("""
    <div style='text-align: center; margin-top: 10px; margin-bottom: 20px;'>
        <i style='color: #38BDF8; font-size: 14px; font-weight: 600; letter-spacing: 0.5px;'>"Energía que mueve el desarrollo"</i>
    </div>
...
if st.session_state.pagina_actual == 'home':
    ...
    with c1:
        # Usamos la imagen generada como portada también
...
# ==================================================
# VISTA 2: TALARA (IMAGEN NUEVA AGREGADA)
# ==================================================
    ...
    st.write("")
    # --- AQUÍ ESTÁ LA IMAGEN QUE PEDISTE ---
